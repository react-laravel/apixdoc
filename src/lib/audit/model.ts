export const AUDIT_ACTIONS = {
  ...
  "user.profile": "修改个人资料",
  "user.password-changed": "修改密码",
  "user.password-reset": "重设密码",
  "user.sessions-revoked": "退出全部设备",
  "user.disabled": "停用账号",
  "user.enabled": "启用账号",
  "user.restored": "恢复账号",
  "user.role-changed": "修改账号角色",
  "user.recovery-issued": "生成账号恢复链接",
  "user.recovery-revoked": "撤销账号恢复链接",
  "user.created": "创建账号",
  "user.deleted": "删除账号",
